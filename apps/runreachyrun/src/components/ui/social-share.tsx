...
export function SocialShare({ title, url, summary, className = "" }: SocialShareProps) {
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <span className="text-xs font-mono text-[var(--text-muted)]">Share:</span>
      ...
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          <path d="M0 0v24h24V0H0zm12.8 14.4v5.6h-1.6v-5.6L7.2 6.4h1.8l3 5.7 3-5.7h1.8l-4 8z" />
        </svg>
      </a>
